    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; i++) {
            ...
            if(N / (double)H == N / H) {
                ...
                if (N / H < 10) System.out.println(H + "0" + tail);
                else System.out.println(H + "" + tail);

            } else if (N / (double)H > N / H) {
                int head = N % H;
                int tail = (N / H) + 1;

                if (tail < 10) System.out.println(head + "0" + tail);
                else System.out.println(head + "" + tail);
            }

//        두번째 풀이
//            String floor = String.valueOf(N % H);
//            String roomNumber = String.valueOf(N / H + 1);
//
//            if (floor.equals("0")) {
